...
exports.RouteNotFound = exports.PrismaError = exports.UserNotFoundError = exports.ParamMissingError = exports.CustomError = void 0;
...
class PrismaError extends CustomError {
    constructor(errorMessage, httpStatus) {
...
RouteNotFound.msg = 'Requested Route Could Not Be Found.';
RouteNotFound.httpStatus = http_status_codes_1.default.BAD_REQUEST;
